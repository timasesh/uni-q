...
const dict: Record<Lang, Record<string, string>> = {
  rus: {
    ...
    catStatement: "Заявление",
    catCertificate: "Справки",
    catRegistration: "Регистрация",
    catOther: "Другое",
    ...
    adminFilterStudentName: "Студент",
    adminFilterStudentNamePh: "имя или фамилия…",
    ...
    adminBookingsColRegistered: "Дата регистрации",
    adminLoad: "Нагрузка",
    adminLoadTitle: "Нагрузка очередей",
    adminLoadHint:
      "Показывает 31 день выбранного месяца и 12 месяцев выбранного года: регистрации талонов и вызовы к окну.",
    adminLoadPickDate: "Дата",
    adminLoadRegistrations: "Регистрации",
    adminLoadCalls: "Вызовы",
    adminLoadChartAria: "График нагрузки по дням и месяцам",
    ...
    chatWidgetThinking: "Печатаю ответ…",
    chatWidgetErrorUnavailable: "Помощник временно недоступен. Попробуйте позже.",
    chatWidgetErrorInvalid: "Не удалось отправить сообщение. Обновите страницу и попробуйте снова.",
    chatWidgetErrorUpstream: "Не удалось получить ответ. Попробуйте ещё раз через минуту.",
    chatWidgetFooter:
      "Ответы генерирует ИИ (NVIDIA). Это не замена консультанта: личные вопросы и документы — к сотруднику в центре.",
  ...
  eng: {
    ...
    adminFilterStudentName: "Student",
    adminFilterStudentNamePh: "first or last name…",
    ...
    adminBookingsColRegistered: "Registered at",
    adminLoad: "Workload",
    adminLoadTitle: "Queue workload",
    adminLoadHint:
      "Shows 31 days of the selected month and 12 months of the selected year: ticket registrations and desk calls.",
    adminLoadPickDate: "Date",
    adminLoadRegistrations: "Registrations",
    adminLoadCalls: "Calls",
    adminLoadChartAria: "Workload chart by days and months",
    ...
    chatWidgetThinking: "Thinking…",
    chatWidgetErrorUnavailable: "The assistant is temporarily unavailable. Please try again later.",
    chatWidgetErrorInvalid: "Could not send the message. Refresh the page and try again.",
    chatWidgetErrorUpstream: "Could not get a reply. Please try again in a minute.",
    chatWidgetFooter:
      "Replies are generated by AI (NVIDIA). It does not replace staff: bring personal or document questions to the desk.",
  ...
  kaz: {
    ...
    catStatement: "Өтініш",
    catCertificate: "Анықтамалар",
    catRegistration: "Тіркеу",
    catOther: "Басқа",
    historyStudent: "Студент",
    ...
    adminFilterStudentName: "Студент",
    adminFilterStudentNamePh: "аты немесе тегі…",
    ...
    adminBookingsColRegistered: "Тіркелген күні",
    adminLoad: "Жүктеме",
    adminLoadTitle: "Кезек жүктемесі",
    adminLoadHint:
      "Таңдалған айдың 31 күні және таңдалған жылдың 12 айы бойынша талон тіркеуі мен шақыру санын көрсетеді.",
    adminLoadPickDate: "Күні",
    adminLoadRegistrations: "Тіркеулер",
    adminLoadCalls: "Шақырулар",
    adminLoadChartAria: "Күндер мен айлар бойынша жүктеме диаграммасы",
    ...
    chatWidgetThinking: "Жауап дайындауда…",
    chatWidgetErrorUnavailable: "Көмекші уақытша қолжетімсіз. Кейінірек қайталап көріңіз.",
    chatWidgetErrorInvalid: "Хабар жіберілмеді. Бетті жаңартып, қайталап көріңіз.",
    chatWidgetErrorUpstream: "Жауап алынбады. Бір минуттан кейін қайталап көріңіз.",
    chatWidgetFooter:
      "Жауаптарды ЖИ (NVIDIA) жасайды. Бұл кеңесшіні алмастырмайды: жеке мәселелер мен құжаттар — орталықтағы қызметкерге.",
